...
cmd = './gbdt -t 8 -s 6 ../data/dup/dvalid2_.csv ../data/dup/dvalid2_sparse.csv ' \
...
cmd = './ffm-train -k 4 -t 20 -l 0.04 --auto-stop -s {nr_thread} -p ../data/dup/va2.ffm ../data/dup/train1.ffm model'.format(nr_thread=NR_THREAD)
#subprocess.call(cmd, shell=True)
...
cmd = './ffm-predict ../data/dup/train1.ffm model ../data/dup/tr.out'.format(nr_thread=NR_THREAD)
#subprocess.call(cmd, shell=True)
